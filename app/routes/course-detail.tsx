                ...
                {mod.lessons.map((lesson) => (
                  <li key={lesson.slug}>
                    <Link
                      ...
                      className="flex items-center justify-between px-6 py-4 hover:bg-amber-50/30 transition-colors group"
                    >
                      <div className="flex items-center gap-3">
                        <div className="w-6 h-6 rounded-full border-2 border-gray-200 group-hover:border-amber-400 transition-colors flex items-center justify-center">
                          <svg
                            width="10"
                            height="10"
                            viewBox="0 0 24 24"
                            fill="currentColor"
                            className="text-gray-300 group-hover:text-amber-400 ml-0.5"
                          >
